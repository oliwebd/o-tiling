...
1. **Download** `o-tiling@oliwebd.github.com.zip` from the [GitHub Releases page](https://github.com/oliwebd/o-tiling/releases/tag/v2.8.0).
...
## 🔗 Links
- **License:** GPLv3 — forked from [System76 pop-shell](https://github.com/pop-os/shell), extended with Aura border, skip overview, panel transparency, theme consistency, and more.
