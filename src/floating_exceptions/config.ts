...
export const DEFAULT_FLOAT_RULES: Array<FloatRule> = [
    ...
    // Gecko forks inherit Firefox's PIP behavior (title != normal window title), Chromium always titles it "Picture in picture"
    { class: '^zen', title: '^(?!.*Zen Browser).*$' },
    { class: 'librewolf', title: '^(?!.*LibreWolf).*$' },
    { class: 'Brave-browser', title: 'Picture.in.picture' },
    { class: 'Microsoft-edge', title: 'Picture.in.picture' },
    { class: 'Google-chrome', title: 'Picture.in.picture' },
    { class: 'Chromium', title: 'Picture.in.picture' },
    { class: 'Vivaldi-stable', title: 'Picture.in.picture' },
